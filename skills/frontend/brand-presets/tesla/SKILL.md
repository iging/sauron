---
name: brand-tesla
description: Visual design preset and token system for tesla.
department: frontend
ownerAgent: aragorn
triggerCommand: /brand-tesla
...
### Touch Targets
- Primary CTA buttons: 200px  40px minimum (well above 4444px WCAG requirement)
