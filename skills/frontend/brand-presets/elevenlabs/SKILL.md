...
department: frontend
ownerAgent: aragorn
triggerCommand: /brand-elevenlabs
...
**`footer`**  -  Closing footer. Background `{colors.canvas}`, text `{colors.body}`. 5-column link list. 6448px padding.
...
|---|---|---|
| Mobile | < 640px | Hero h1 6432px; feature cards 1-up; nav hamburger; gradient orbs shrink. |
