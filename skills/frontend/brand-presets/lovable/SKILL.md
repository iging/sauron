---
name: brand-lovable
description: Visual design preset and token system for lovable.
department: frontend
ownerAgent: aragorn
triggerCommand: /brand-lovable
...
- **Variable weight as design tool**: The font supports continuous weight values (for example, 480), enabling nuanced hierarchy beyond standard weight stops. Weight 480 at 60px creates a display style that feels lighter than semibold but stronger than regular.
