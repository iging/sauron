---
name: brand-runwayml
description: Visual design preset and token system for runwayml.
department: frontend
ownerAgent: aragorn
triggerCommand: /brand-runwayml
...
- Weight 450 (unusual intermediate) for small uppercase text  -  precision - Editorial magazine layout with mixed-size image grids
...
- **Weight 450  -  the precision detail**: Some small uppercase labels use weight 450, an uncommon intermediate between regular (400) and medium (500). This micro signals typographic sophistication.
