...
department: frontend
ownerAgent: aragorn
triggerCommand: /brand-clickhouse
...
Inter is open-source and the documented choice. **Shne** is a close commercial alternative if licensed. **Geist** is another modern alternative.
...
|---|---|---|
| Mobile | < 768px | Hamburger nav; hero h1 7236px; code-window-card stacks below; feature grids 1-up; pricing 1-up |
