...
|---|---|---|
| Mobile | < 768px | Hamburger nav; hero h1 6432px; hero-illustration-card stacks below content; feature grids 1-up; connector tiles 2-up; pricing 1-up; footer 4 cols  1 |
...
- Copernicus and StyreneB are licensed Anthropic typefaces and not available as public web fonts. Substitutes (Tiempos Headline / Cormorant Garamond / EB Garamond for serif; Inter / Shne for sans) are documented in the typography section.
