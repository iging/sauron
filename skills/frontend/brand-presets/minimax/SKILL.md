...
**`button-icon-circular`**  -  3636px circular utility button (carousel arrows, share, copy).
...
- Top row: MiniMax wordmark ("intelligence with everyone" tagline) and social icons (X, Twitter, GitHub, and so forth. ).
...
- Circular icon buttons: 3636px desktop  4444px on mobile.
...
- **Stats strip**: 4-column  22 at < 768px  1-column at < 480px.
