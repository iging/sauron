---
name: brand-theverge
description: Visual design preset and token system for theverge.
department: frontend
ownerAgent: aragorn
triggerCommand: /brand-theverge
...
- Background: saturated accent (`#3cffd0`, `#5200ff`, yellow, and so forth. )
