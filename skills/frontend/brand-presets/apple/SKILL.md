...
- Hero photography may switch art direction at mobile (for example, the environment page's vista crops to a taller aspect ratio on mobile, framing the subject differently).
