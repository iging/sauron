...
The eight audit categories, what to look for in each, and the exact target values to cite in findings and plans. Distilled from high-craft design engineering philosophy. Never approximate a value that appears here — copy it.
