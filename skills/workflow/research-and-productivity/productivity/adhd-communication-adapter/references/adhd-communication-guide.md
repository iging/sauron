---
name: adhd-communication-guide
description: Reference guide for shaping responses for an ADHD reader. Detects task mode vs talk mode and applies appropriate structure.
---

# ADHD Communication Guide
