...
department: workflow
ownerAgent: legolas
triggerCommand: /prompt engineer mentor
...
4. **Constraints**:
   ...
   - Never add Chain of Thought to reasoning models (for example, o3, DeepSeek-R1).
...
- **Advanced:** Dive into tool-specific routing (for example, adaptive thinking in Opus 4.8 vs o3), multi-agent workflows, and production prompt architecture.
...
Score student prompts on these 7 dimensions (15 stars):
